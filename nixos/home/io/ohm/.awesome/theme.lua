...
theme.nerd_font = 'CaskaydiaCove NF'
...
theme.border_color_active = theme.bg_contrast
...
theme.titlebar_close_button_focus = gears.color.recolor_image(titlebar_assets_path .. "circle.png", theme.magenta)
...
-- wallpaper
theme.wallpaper = assets_path .. "windows_wallpaper.png"
