...
awful.keyboard.append_global_keybindings({
	...
	end, { description = "open screenshot tool", group = "awesome" }),

	awful.key({ modkey, "Shift" }, "d", function()
		awful.spawn.with_shell(file_manager)
	end, { description = "open file manager", group = "awesome" }),

	awful.key({ modkey, "Shift" }, "p", function()
		awful.spawn.with_shell(powermenu)
	end, { description = "open powermneu", group = "awesome" }),

  awful.key({ modkey }, "p", function()
    player.visible = not player.visible 
  end, { description = "toggle music player", group = "awesome" }),
 })
